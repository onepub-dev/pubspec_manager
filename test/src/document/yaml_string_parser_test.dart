...
void main() {
  test('yaml scalar', () async {
    ...
    final (machine, result) = await parseString(doubleQuoted);
...
Future<void> doTest(String input, String expected) async {
  final (machine, result) = await parseString(input);
...
StateBuilder<FlowPlain> flowPlainBuilder(
    ...
    b
      ...
      ..state<PlainEscaping>((b) => b
        ...
        ..on<OnEscapeChar, FlowDoubleQuoted>(sideEffect: (e) async => append(e))
