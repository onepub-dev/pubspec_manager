...
part 'documentation_attached.dart';
...
part 'git_dependency_builder.dart';
part 'homepage.dart';
part 'hosted_dependency.dart';
part 'hosted_dependency_builder.dart';
part 'issue_tracker.dart';
part 'issue_tracker_builder.dart';
part 'path_dependency.dart';
part 'path_dependency_builder.dart';
part 'pub_hosted_dependency.dart';
part 'pub_hosted_dependency_builder.dart';
part 'pub_spec.dart';
